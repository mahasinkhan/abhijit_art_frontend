...
.g-paid{display:flex;justify-content:center;font-size:6pt;font-weight:800;letter-spacing:1px;color:#8affc0;margin-top:1mm;padding-top:1mm;border-top:.5px solid rgba(255,255,255,.35)}
  ...
  <div class="page">
    ...
    <div class="bot">
      ...
      <div class="bot-r">
        ...
        <div class="grand"><div class="g-row"><span>Total Amount</span><span class="g-val">₹${p.total.toFixed(2)}</span></div>${due>0.005?`<div class="g-due"><span>Balance Due</span><span>₹${due.toFixed(2)}</span></div>`:paidInFull?`<div class="g-paid"><span>✓ PAID IN FULL</span></div>`:""}</div>
