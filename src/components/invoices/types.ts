...
export const sharedSt = {
  ...
  editModal:{ width:"100%", maxWidth:760, maxHeight:"90vh", overflowY:"auto" as const, overscrollBehavior:"contain" as const, background:"#fffdfb", border:`1px solid ${LINE}`, boxShadow:"0 30px 80px rgba(24,22,28,.34)", padding:24, boxSizing:"border-box" as const },
